        ...
        data.map(async (d) =>{
            ...
            <div class="col-xl-6">
                <div class="blog-list active">
                    <div class="post-thumbnail"><a href="/blog.html?id=${d.id}"><img style="width: 300px !important; height: 240px !important;   object-fit: cover;"
            ...
            data.map(async (d) =>{
                ...
                <div class="single-post" >
                                        <div class="post-thumbnail">
                                            <a href="/blog.html?id=${d.id}" id="recentLink"><img src="${imgDetails.src}" id="recentImage" style="width:100px; height:80px;" alt="${imgDetails.src}"></a>
                                        </div>
                                        <div class="post-content">
